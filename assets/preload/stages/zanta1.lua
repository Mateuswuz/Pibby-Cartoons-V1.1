...
function onCreate()
    ...
    makeLuaSprite('zanta2', 'zanta2', -400, -50);
    scaleObject('zanta2', 1.9, 1.9)
    addLuaSprite('zanta2', false);
    setProperty('zanta2.visible',false)

	makeLuaSprite('zanta1', 'zanta1', -400, -50);
    scaleObject('zanta1', 1.2, 1.2)
    addLuaSprite('zanta1', false);
